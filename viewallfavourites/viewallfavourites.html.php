...
include_once MAIN_FILE . '/header.inc.php';?>
	...
	<div class = "maincont_for_view"> 
		...
		<div>
		 <h3 align = "center">Избранные каналы</h3>
		 <?php 
		 if (empty ($favourites_prom)) 
				{
		 ...
		 foreach ($favourites_prom as $favourite): ?> 
			...
			<?php endforeach; ?>
			<?php echo $viewAllChannalsLink;?>
		</div>
		<div>
		 <h3 align = "center">Избранные статьи</h3>
		 <?php 
		 if (empty ($favourites_post)) 
				{
					echo '<p align = "center">Материалы отсутствуют</p>';
					$favourites = '';
				}
		 ...
		 foreach ($favourites_post as $favourite): ?> 
